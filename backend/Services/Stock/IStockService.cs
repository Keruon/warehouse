...
public interface IStockService
{
    ...
    Task<StockLevelResponse> ReturnProjectStockAsync(Guid stockLocationId, int quantity, CancellationToken cancellationToken = default);
    Task<CloseProjectResponse> CloseProjectAsync(Guid projectLocationId, bool confirm, CancellationToken cancellationToken = default);
